...
home = os.path.expanduser('~') + '/kaggle/pytorch_classification/data'
## 预训练模型的存放位置
LOCAL_PRETRAINED = {
    'resnext50_32x4d': home + '/weights/resnext50_32x4d.pth',
    ...
    'efficientnet-b4': '/workspace/BBN/cassava/pretrained_models/efficientnet-b4.pth',
